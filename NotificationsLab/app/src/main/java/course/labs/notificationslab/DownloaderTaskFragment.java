...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> resIDList =
                getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);

        // Start the DownloaderTask
        downloaderTask.execute(resIDList.toArray(new Integer[0]));
